...
add_shortcode( 'rusty-login-form', 'rusty_create_login_form');
function rusty_create_login_form($atts, $content = null)
{
  $html = '';
  ...
  if ($logged_in === false) {
    ...
    ?> <!-- ----------------- HTML ------------------ -->
	 ...
	 <br/>
	 Click here to <?php rusty_create_logout_link(true); ?>
      </div><!-- login-form-wrapper -->
    <?php
  }    
 ...
 * site.
 */
add_shortcode( 'rusty-logout-link', 'rusty_create_logout_link');
function rusty_create_logout_link($return = 0)
{
