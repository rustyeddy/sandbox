...
add_shortcode( 'rusty', 'rusty_rusty');
function rusty_rusty($atts, $content = null)
{
    ...
    echo "Do What Rusty? <br/>";
}


// Just to trigger interesting things
add_shortcode( 'rusty-debug', 'rusty_debug');
function rusty_debug($atts, $content = null)
{
